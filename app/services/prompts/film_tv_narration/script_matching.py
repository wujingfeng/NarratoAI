...
12. OST=1 原声片段的数量占比要尽量接近用户选择的 ${original_sound_ratio}%。计算方式：OST=1 的 items 数量 / 全部 items 数量。不要按 timestamp 总时长计算。
...
- 因为第一段必须 OST=0、剧情连贯性、非剧情片段过滤或字幕素材限制，OST=1 数量占比允许有 ±1 个片段误差。
